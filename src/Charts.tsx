			...
			<nav className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
				<div className="flex items-center justify-between p-4 max-w-7xl mx-auto gap-4">
					...
					<div className="flex gap-2">
						...
						<Button
							variant="outline"
							onClick={() => scrollToSection("passenger-class")}>
							Passenger Class
						</Button>
						<Button
							variant="outline"
						...
						<Button
							variant="outline"
							onClick={() => scrollToSection("embarkation")}>
							Embarkation
						</Button>
					</div>
				</div>
													...
													return (
														<text
															...
															<tspan
																...
																{aliveradialData[0].value.toLocaleString()}
															</tspan>
															<tspan
																x={viewBox.cx}
																y={(viewBox.cy || 0) + 24}
													...
													return (
														<text
															...
															<tspan
																...
																y={viewBox.cy}
																className="fill-foreground text-4xl font-bold">
																{unaliveradialData[0].value.toLocaleString()}
															</tspan>
															<tspan
																x={viewBox.cx}
																y={(viewBox.cy || 0) + 24}
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
					...
					<Card className="flex flex-col h-full">
						...
						<CardFooter className="flex-col gap-2 text-sm">
							<div className="flex items-center gap-2 font-medium leading-none"></div>
							<div className="leading-none text-muted-foreground">
								This chart compares the number of female passengers who survived to those who did not survive the
								Titanic sinking.
							</div>
						</CardFooter>
					</Card>
					...
					<Card>
						...
						<CardFooter className="flex-col items-start gap-2 text-sm">
							<div className="leading-none text-muted-foreground">
								...
								Queenstown (Q), and Southampton (S), providing insight into where travelers began their journey aboard
								the Titanic.
							</div>
						</CardFooter>
					</Card>
